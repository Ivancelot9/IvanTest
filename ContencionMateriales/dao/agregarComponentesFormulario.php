...
session_start();
include_once "conexionContencion.php";  // tu clase para conectar
...
// 3) Lista blanca de catálogos
$catalogs = [
    'responsable' => ['table' => 'Responsables', 'col' => 'NombreResponsable', 'id' => 'IdResponsable'],
...
try {
    ...
    // 5) Devuelvo JSON con el nuevo elemento
    echo json_encode([
        'status' => 'success',
        'id' => $newId,
        'name' => $name,
